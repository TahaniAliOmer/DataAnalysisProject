Select *
From [Covid-19Project]..CovidDeath
...
From [Covid-19Project]..CovidDeath dea
Join [Covid-19Project]..CovidVaccination vac
...
Join [Covid-19Project]..CovidVaccination vac
	On dea.location = vac.location
	and dea.date = vac.date
where Population <> 0 and dea.continent is not null 
--order by 2,3
)
